 ...
 */
export const projectMemberMiddleware = async (
  req: AuthRequest,
  res: Response,
  next: NextFunction
) => {
  try {
    ...
    const memberResult = await query(
      'SELECT public.is_project_member($1::UUID, $2::UUID) as is_member',
      [projectId, profileId]
    );
 ...
 */
export const projectLeaderMiddleware = async (
  req: AuthRequest,
  res: Response,
  next: NextFunction
) => {
 ...
 */
export function projectLeaderOfResourceMiddleware(
  resolveProjectId: (req: AuthRequest) => Promise<string | null>
) {
 ...
 */
export const canCreateProjectMiddleware = (
  req: AuthRequest,
  res: Response,
  next: NextFunction
) => {
 ...
 */
export const reportsAccessMiddleware = (
  req: AuthRequest,
  res: Response,
  next: NextFunction
) => {
