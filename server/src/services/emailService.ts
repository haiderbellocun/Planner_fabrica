...
export function buildMentionEmailHtml(data: MentionEmailData): string {
  const { mentionedName, commenterName, projectName, taskTitle, commentExcerpt, taskLink } = data;
    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
          ...
          <td style="background:#0BBFB7;border-radius:14px 14px 0 0;padding:28px 36px;">
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td>
                  <p style="margin:0;color:rgba(255,255,255,0.8);font-size:12px;font-weight:600;letter-spacing:1px;text-transform:uppercase;">Planner Fábrica</p>
                  <h1 style="margin:4px 0 0;color:#fff;font-size:22px;font-weight:700;">Te mencionaron en un comentario</h1>
                </td>
                <td align="right">
                  <img src="https://storage.googleapis.com/it-fab-contenido-edu-1-planner-web/Logo_coordinador_de_fabrica.png"
                       alt="Planner Fábrica"
        ...
        <tr>
          <td style="background:#fff;padding:36px;border-left:1px solid #e2e8f0;border-right:1px solid #e2e8f0;">
            <p style="margin:0 0 4px;color:#64748b;font-size:14px;">Hola,</p>
            <h2 style="margin:0 0 20px;color:#0f172a;font-size:20px;font-weight:700;">${mentionedName}</h2>

            <p style="margin:0 0 6px;color:#475569;font-size:15px;">
              <strong>${commenterName}</strong> te mencionó en un comentario en el proyecto:
            </p>
            <p style="margin:0 0 24px;color:#0BBFB7;font-size:15px;font-weight:700;">${projectName}</p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0"
              ...
              <tr>
                <td style="padding:18px 20px;">
                  <p style="margin:0 0 8px;font-size:17px;font-weight:700;color:#0f172a;">${taskTitle}</p>
                  <p style="margin:0;font-size:14px;color:#475569;font-style:italic;">"${commentExcerpt}"</p>
                </td>
              </tr>
            </table>
